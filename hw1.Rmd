...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Dev Narendra Rokade**, my major is *Computer Science* and my minor is in *Data Science*. I am an international student from India, and this is my second semester here at ISU.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: I think the job of a data analyst is related to data science.[link](https://www.northeastern.edu/graduate/blog/what-does-a-data-analyst-do/). ![Data Scientist](/Users/devrokade/Downloads/istock-817442226.jpg)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am more interested in Machine Learning.
